...
onmt_train -data data/multi30k.atok.low -save_model ./ckpt/multi30k_model -world_size 8 -gpu_ranks 0 1 2 3 4 5 6 7 -rnn_type $2 -input_feed $3 -train_steps $_step -start_decay_steps 10000 -decay_steps 1500 -learning_rate 1.0 -learning_rate_decay 0.9 -batch_size 256
...
# 
onmt_train -data data/multi30k.atok.low -save_model ./ckpt2/multi30k_model -world_size 8 -reset_optim all -gpu_ranks 0 1 2 3 4 5 6 7 -rnn_type $2 -input_feed $3 -train_steps $_step -start_decay_steps 10000 -decay_steps 1500 -learning_rate 1.0 -learning_rate_decay 0.9 --retrain -batch_size 256 --train_from ./ckpt/$ckpts
